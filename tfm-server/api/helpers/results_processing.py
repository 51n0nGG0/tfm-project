def process_explicit_language_results(results):
    ...
    if "EXPLICIT" in results:
        diagnostics.append({
            ...
            "appliesTo": ["PHISHING", "EMOTIONAL SOCIAL ENGINEERING"],
            "failureDetails": {
                "reason": "",
                "evidence": {
                    "location": "body",
...
def process_urgent_language_results(results):
    ...
    if "URGENT" in results:
        diagnostics.append({
            ...
            "appliesTo": ["PHISHING", "BUSINESS EMAIL COMPROMISE", "EMOTIONAL SOCIAL ENGINEERING"],
            "failureDetails": {
                "reason": "",
                "evidence": {
                    "location": "body",
...
def process_identity_impersonation_results(results):
    ...
    if "IMPERSONATION" in results:
        diagnostics.append({
            ...
            "appliesTo": ["PHISHING", "BUSINESS EMAIL COMPROMISE"],
            "failureDetails": {
                "reason": "",
                "evidence": {
                    "location": "body",
...
def process_request_transference_results(results):
    ...
    if "REQUESTED" in results:
        diagnostics.append({
            ...
            "appliesTo": ["BUSINESS EMAIL COMPROMISE", "EMOTIONAL SOCIAL ENGINEERING"],
            "failureDetails": {
                "reason": "",
                "evidence": {
                    "location": "body",
